...
import com.example.rm_10.databinding.ListItemBinding

class ItemAdapter(private val listener: Listener, private val adapterType: Boolean) :
    androidx.recyclerview.widget.ListAdapter <ListItem, ItemAdapter.MyHolder>(Comporator()) {
    ...
    class Comporator : DiffUtil.ItemCallback<ListItem>(){
