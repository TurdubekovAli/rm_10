...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull CardView rootView, @NonNull CheckBox checkBox,
      @NonNull TextView mac, @NonNull TextView name) {
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mac;
      TextView mac = ViewBindings.findChildViewById(rootView, id);
      if (mac == null) {
        break missingId;
      }
      ...
      return new ListItemBinding((CardView) rootView, checkBox, mac, name);
    }
